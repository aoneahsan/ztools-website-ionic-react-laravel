...
const ZWordCounter: React.FC = () => {
  ...
  return (
    <>
      {/* Side menu */}
      <ZAppSideMenu pageId={CONSTANTS.PAGE_IDS.WORD_COUNTER_PAGE_ID} />
            ...
            <ZIonRow>
              ...
              >
                ...
                <ZIonText className="block mt-1">
                  ...
                  various contexts, including academic papers, articles,
                  reports, and creative writing. Word count is valuable for
                  writers, editors, and students as it helps ensure that a
                ...
                <ZIonText className="block mt-1">
                  ...
                  of a document and can be important in scenarios where space is
                ...
                <ZIonText className="block mt-1">
                  ...
                  sounds. Syllable count is valuable for assessing the
                  readability and pronunciation of words and sentences, and it
                  can be essential in fields like linguistics and language
                  processing.
                </ZIonText>
                ...
                <ZIonText className="block mt-1">
                  ...
                  the complexity and readability of text. Sentence count can
                  help writers and editors ensure that paragraphs and sections
                  are well-structured.
                </ZIonText>
                ...
                <ZIonText className="block mt-1">
                  ...
                  formatting and style analysis. Writers and editors use
                  paragraph count to ensure proper document structure and
                  readability.
                </ZIonText>
              </ZIonCol>
            </ZIonRow>
