          ...
          <ZIonRow>
                  ...
                  return (
                    <>
                      <div className="flex ion-align-items-center">
                        ...
                        />
                        <ZIonText className="mx-1">is what percent of</ZIonText>
                        <ZIonInput
                          className="w-[10rem] me-1"
                          minHeight="2.3rem"
                          type="number"
            ...
            >
              <div className="ion-text-center">
                <ZIonText className="text-sm">
                  <strong>Tips</strong>: Use tab to move to the next field. Use
            ...
            <ZIonCol className="p-2 mt-5" size="12">
              ...
              <ZIonText className="block mt-2">
                Welcome to Zaions' comprehensive percentage calculator, designed
                to offer quick and accurate percentage calculations for a
                variety of scenarios. From daily math problems like determining
                tips and discounts, to more complex applications such as
                assessing growth metrics and percentage differences, our
                calculator serves as an indispensable tool for both personal and
                professional use.
              </ZIonText>
            </ZIonCol>
            ...
            <ZIonCol className="p-2 mt-5" size="12">
              ...
              <ZIonAccordionGroup>
                <ZIonAccordion value="first">
                  ...
                  <div className="ion-padding" slot="content">
                    <ZIonText>
                      ...
                      sizes, quantities, or even entire datasets. For instance,
                      40% can be expressed as 0.4 in decimal or 2/5 in
                      fractions.
                    </ZIonText>
                  </div>
                </ZIonAccordion>
                ...
                <ZIonAccordion value="second">
                  ...
                  <div className="ion-padding" slot="content">
                    <ZIonText className="block">
                      ...
                      100. For example, if a company has 100 employees, with 60
                      of them being female, the ratio of female employees to
                      total employees is 0.6. Multiplied by 100, it translates
                      to 60%, meaning 60% of the company's workforce is female.
                    </ZIonText>
                    ...
                    <div className="ms-3">
                      <ZIonText className="block">P is the percentage</ZIonText>
                      <ZIonText className="block">
                        V1 is the initial value
                      </ZIonText>
                      <ZIonText className="block">
                        V2 is the resulting value after applying the percentage
                      </ZIonText>
                    </div>
                    ...
                    <ZIonText className="block mt-3">
                      ...
                      allowing for real-time, accurate calculations to assist in
                ...
                <ZIonAccordion value="third">
                  <ZIonItem slot="header" color="light">
                    <ZIonLabel className="">Why Use Our Calculator?</ZIonLabel>
                  </ZIonItem>
                  <div className="ion-padding" slot="content">
                    <ZIonText>
                      Powered by Zaions' trusted technology, our percentage
                      calculator simplifies complex percentage calculations,
                      saving you time and reducing the chance of errors. Whether
                      you're a student, a professional, or just someone trying
                      to figure out the complexities of percentages, our
                      calculator aims to provide you with reliable, quick, and
                      accurate results.
                    </ZIonText>
                  </div>
                </ZIonAccordion>
            ...
            {/* Copy rigth */}
            <ZIonCol className="p-2 mt-5" size="12">
              <ZIonTitle className="text-sm">
                &copy; 2023 Zaions Digital
              </ZIonTitle>
            </ZIonCol>
          </ZIonRow>
        </ZIonGrid>
